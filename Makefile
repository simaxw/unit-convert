...
# Generated by qmake (3.0) (Qt 5.0.2) on: Sun Jun 2 17:16:02 2013
# Project:  convert.pro
# Template: app
...
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++-64 -I. -Iinc -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtScript -I/usr/include/qt/QtXml -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I.obj -I.obj
LINK          = g++
...
SOURCES       = src/main.cpp \
		src/about.cpp \
		src/parser.cpp .obj/moc_main.cpp \
		.obj/moc_about.cpp
OBJECTS       = .obj/main.o \
		.obj/about.o \
		.obj/parser.o \
...
$(TARGET): .obj/ui_about.h .obj/ui_mainwindow.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .obj/convert1.0.0/ && $(COPY_FILE) --parents inc/main.hpp inc/about.hpp inc/parser.hpp inc/unit.hpp .obj/convert1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/about.cpp src/parser.cpp .obj/convert1.0.0/ && $(COPY_FILE) --parents ui/about.ui ui/mainwindow.ui .obj/convert1.0.0/ && (cd `dirname .obj/convert1.0.0` && $(TAR) convert1.0.0.tar convert1.0.0 && $(COMPRESS) convert1.0.0.tar) && $(MOVE) `dirname .obj/convert1.0.0`/convert1.0.0.tar.gz . && $(DEL_FILE) -r .obj/convert1.0.0
...
compiler_uic_make_all: .obj/ui_about.h .obj/ui_mainwindow.h
compiler_uic_clean:
	-$(DEL_FILE) .obj/ui_about.h .obj/ui_mainwindow.h
.obj/ui_about.h: ui/about.ui
	/usr/lib/qt/bin/uic ui/about.ui -o .obj/ui_about.h

.obj/ui_mainwindow.h: ui/mainwindow.ui
	/usr/lib/qt/bin/uic ui/mainwindow.ui -o .obj/ui_mainwindow.h
...
.obj/main.o: src/main.cpp inc/main.hpp \
		...
		/usr/include/qt/QtXml/QXmlInputSource \
		/usr/include/qt/QtXml/QXmlDefaultHandler \
		/usr/include/qt/QtXml/QXmlSimpleReader \
